...
| Doc                                                                    | Purpose                                                                                                       | Status                                  |
| ---------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------- | --------------------------------------- |
| [Documentation Standards](platform/doc-standards.md)                   | Writing rules, evidence rules, reuse matrix format, migration/test standards, MVP guardrails                  | **ACTIVE / SOURCE OF TRUTH**            |
| [Brands](../docs/ipix-platform/docs/ipix-platform/10-brands/BRANDS.md) | First completed domain template: current state, journeys, repo adaptations, gaps, architecture, phases, tests | **ACTIVE / TEMPLATE FOR OTHER DOMAINS** |
...
| ----: | ---------- | ----------------------------------------------------------------------------------- | --------------------------------------------------------------- |
|    10 | Brands     | [10-brands/BRANDS.md](../docs/ipix-platform/docs/ipix-platform/10-brands/BRANDS.md) | Brand website → Brand DNA → human review → approved context     |
...
1. Read this index.
2. Read [Documentation Standards](platform/doc-standards.md).
3. Read [Brands](../docs/ipix-platform/docs/ipix-platform/10-brands/BRANDS.md) as the domain-writing/template example.
