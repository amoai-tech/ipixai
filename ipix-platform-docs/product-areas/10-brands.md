...
Read [BRANDS.md](../../docs/ipix-platform/docs/ipix-platform/10-brands/BRANDS.md) for the evidence-backed current state, user journeys, reuse map, architecture, implementation phases, tests, and references.
