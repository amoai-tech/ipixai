...
const generated = spawnSync(
  process.execPath,
  [playwrightCli, "init-agents", "--loop=claude", "--project=playwright-agent"],
...
if (JSON.stringify(mcp) !== JSON.stringify(expectedMcp)) {
  throw new Error("Unexpected .mcp.json from installed Playwright; review before committing");
}
