...
-- Purpose: Replace stale shoot.shoot_assets source in get_shoot_detail with canonical
--          public.assets.v2_shoot_id + optional cloudinary_assets enrichment.
-- IPI-1138 · ASSET-QA-001 — Add aspect_ratio and origin to deliverables for QA
-- Rollback: restore 20260707132407_get_shoot_detail_asset_resource_type.sql body
