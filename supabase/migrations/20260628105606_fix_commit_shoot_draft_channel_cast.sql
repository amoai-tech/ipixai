-- Fix shoot.channel enum casts on commit_shoot_draft (remote SSOT via pg_get_functiondef, IPI-225)
-- Rollback: re-apply 20260628105303 function body (without casts)
