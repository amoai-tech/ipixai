-- IPI-1138 · ASSET-QA-001 — Add aspect_ratio and origin to get_shoot_detail deliverables
-- Purpose: Extend the canonical get_shoot_detail RPC (from 20260912184625) to include
--          aspect_ratio and origin fields in deliverables for Asset QA consumption.
--          Preserves all existing behavior from 20260912184625_ipi1118_shoot_assets_canonical_read.sql.
...
comment on function public.get_shoot_detail(uuid) is
  'IPI-1118 — canonical V2 asset read via public.assets.v2_shoot_id. IPI-721 org-membership authorization (public.is_org_member) preserved. IPI-1138 — deliverables include aspect_ratio and origin for Asset QA.';
