# IPI-1246 PR-Agent Clean-Control Certification

Purpose: verify the merged iPix PR-Agent reviewer does not invent a material blocker for a documentation-only change.
