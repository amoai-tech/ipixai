...
If this file disagrees with [live Linear](https://linear.app/amo100/issue/IPI-1078) or `package.json`, **Linear and the lockfile win**. Brand notes: **[brand.md](./brand.md)** (dumps: [../archive/copilotkit-mastra/brand/](./brand)). CopilotKit notes are **archived** ([../archive/copilotkit-mastra/copilotkit/](./copilotkit)) — they do not mint tickets. **Mint / do-not-add:** [todo.md](./todo.md). Host is **Vercel**, not Cloudflare Workers.
...
Keep the epic **small**. See archived [02-mastra-copilotkit.md](./copilotkit/02-mastra-copilotkit.md). **Do not** register Brand/Campaign agents on the operator route until CORE-001 is proven.
...
| Old Mastra × CF OS / old Brand Lifecycle IPI-46… | **IPI-486**, **IPI-993**, [brand.md](./brand.md) historical table — **do not implement** [19-brand-lifecycle.md](./brand/19-brand-lifecycle.md) |
...
Notes: archived [108](./copilotkit/108-copilotkit.md) · [109](./copilotkit/109-copilotkit.md) · [110](./copilotkit/110.md). Living table is this section. Official URLs: [links.md](./links.md).
...
Evidence dump: [../archive/copilotkit-mastra/tasks/db-001-matrix.md](./tasks/db-001-matrix.md).
