...
Parent architecture: [prd.md](./prd.md). **Pipe → widget → cutover.** Widget needs **IPI-1065 · APP-001** and a saved shoot (**IPI-1067 · SHOOT-001**). Production notifications stay on `www.ipix.co` until Production-ready.
