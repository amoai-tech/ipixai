...
| Need | Current source |
|---|---|
| Media architecture / phase map | [prd.md](./prd.md) |
| Core secure media foundation | [cloudinary-core-prd.md](./cloudinary-core-prd.md) |
| MVP operator media journey | [cloudinary-mvp-prd.md](./cloudinary-mvp-prd.md) |
| Advanced reuse/search/AI | [cloudinary-advanced-prd.md](./cloudinary-advanced-prd.md) |
| Exact external reuse plan | [reuse.md](./reuse.md) |
| Production/recovery runbook | [operations.md](./operations.md) |
| Locked provider contract | [CONTRACT-1110-1112.lock.md](./CONTRACT-1110-1112.lock.md) |
